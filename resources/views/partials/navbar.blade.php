...
<div class="max-w-7xl mx-auto py-12 px-6">
    ...
    <section class="mb-12 bg-orange-500 rounded-2xl shadow-lg p-6 md:p-8 text-white">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
            ...
            {{-- Foto Supporter --}}
            <div class="md:col-span-1">
                {{-- GANTI NAMA FILE GAMBAR INI (misal: 'images/kanata-hongo.jpg') --}}
                <img src="{{ asset('images/kanata-hongo.jpg') }}"
                     alt="Kanata Hongo"
                     class="rounded-lg w-full h-auto object-cover shadow-md"
                     onerror="this.src='https://placehold.co/400x400/f87171/white?text=Kanata+Hongo'">
            </div>
            ...
            <div class="flex justify-between items-center">
                <div>
                    <h3 class="text-3xl font-extrabold text-white">
                        Lihat Jadwal Event Stage
                    </h3>
                    <p class="text-blue-200 mt-1">
                        Jangan lewatkan Keynote, Japan Game Awards, dan sesi spesial dari para developer.
                    </p>
                </div>
                <div class="text-white text-5xl font-light group-hover:translate-x-1 transition duration-300">
                    &rarr;
                </div>
            </div>
        </a>
    ...
    <section class="mb-12">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
            ...
            <div class="md:col-span-2">
                ...
                <img src="{{ asset('images/tgs-visual.jpg') }}"
                     alt="TGS 2025 Visual"
                     class="w-full h-auto object-cover rounded-lg shadow-lg"
                     onerror="this.src='https://placehold.co/800x600/333/FFF?text=TGS+Visual'">
            </div>
            {{-- Teks Visual --}}
            <div class="md:col-span-1">
    ...
    <section class="mb-12">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
            ...
            <div class="md:col-span-2">
                ...
                <img src="{{ asset('images/tgs-logo.jpg') }}"
                     alt="TGS 2025 Logo"
                     class="w-full h-auto object-cover rounded-lg shadow-lg bg-gray-900 p-4"
                     onerror="this.src='https://placehold.co/800x600/111/FFF?text=TGS+Logo'">
            </div>
            {{-- Teks Logo --}}
            <div class="md:col-span-1">
